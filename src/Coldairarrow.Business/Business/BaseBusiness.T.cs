...
namespace Coldairarrow.Business
{
    ...
    public class BaseBusiness<T> : IBaseBusiness<T>, IDependency where T : EntityBase, new()
    {
        #region DI

        public ILogger Logger { protected get; set; }
        public IOperator Operator { protected get; set; }
        ...
        /// 影响条数
        /// </returns>
        public int LogicDelete_Sql(Expression<Func<T, bool>> where)
        {
            return Service.Delete_Sql(where);
        }
